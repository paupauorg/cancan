...
![CanCanCan Logo](/logo/cancan.jpg)

[![Gem Version](https://badge.fury.io/rb/cancan.svg)](http://badge.fury.io/rb/cancan)
[![Travis badge](https://travis-ci.org/CanCanCommunity/cancan.svg?branch=develop)](https://travis-ci.org/CanCanCommunity/cancan)
[![Code Climate Badge](https://codeclimate.com/github/CanCanCommunity/cancan.svg)](https://codeclimate.com/github/CanCanCommunity/cancan)
[![Inch CI](http://inch-ci.org/github/CanCanCommunity/cancan.svg)](http://inch-ci.org/github/CanCanCommunity/cancan)

[Wiki](https://github.com/CanCanCommunity/cancan/wiki) | 
[RDocs](http://rdoc.info/projects/CanCanCommunity/cancan) | 
[Screencast](http://railscasts.com/episodes/192-authorization-with-cancan) | 
[Gitter](https://gitter.im/CanCanCommunity/cancan)
...
Please use `gem 'cancan', '~> 1.10'` for them.

If you are interested in supporting them, contribute to the sibling gems `cancan-sequel` and `cancan-mongoid`.
...
See [Changing Defaults](https://github.com/CanCanCommunity/cancan/wiki/changing-defaults) if you need a different behavior.
...
See [Defining Abilities](https://github.com/CanCanCommunity/cancan/wiki/defining-abilities) for details.
...
See [Checking Abilities](https://github.com/CanCanCommunity/cancan/wiki/checking-abilities) for more information
...
See [Authorizing Controller Actions](https://github.com/CanCanCommunity/cancan/wiki/authorizing-controller-actions) for more information.
...
See [Strong Parameters](https://github.com/CanCanCommunity/cancan/wiki/Strong-Parameters) for more information.
...
See [Exception Handling](https://github.com/CanCanCommunity/cancan/wiki/exception-handling) for more information.
...
See [Ensure Authorization](https://github.com/CanCanCommunity/cancan/wiki/Ensure-Authorization) for more information.


## Wiki Docs

* [Upgrading to 1.6](https://github.com/CanCanCommunity/cancan/wiki/Upgrading-to-1.6)
* [Defining Abilities](https://github.com/CanCanCommunity/cancan/wiki/Defining-Abilities)
* [Checking Abilities](https://github.com/CanCanCommunity/cancan/wiki/Checking-Abilities)
* [Authorizing Controller Actions](https://github.com/CanCanCommunity/cancan/wiki/Authorizing-Controller-Actions)
* [Exception Handling](https://github.com/CanCanCommunity/cancan/wiki/Exception-Handling)
* [Changing Defaults](https://github.com/CanCanCommunity/cancan/wiki/Changing-Defaults)
* [See more](https://github.com/CanCanCommunity/cancan/wiki)
...
[documentation](https://github.com/CanCanCommunity/cancan/wiki) or our 
[mailing list](http://groups.google.com/group/cancan), please 
[open a question on Stackoverflow](http://stackoverflow.com/questions/ask?tags=cancan) with tag 
[cancan](http://stackoverflow.com/questions/tagged/cancan)

## Bugs?

If you find a bug please add an [issue on GitHub](https://github.com/CanCanCommunity/cancan/issues) or fork the project and send a pull request.
...
See the [CONTRIBUTING](https://github.com/CanCanCommunity/cancan/blob/develop/CONTRIBUTING.md) and 
[spec/README](https://github.com/CanCanCommunity/cancan/blob/master/spec/README.rdoc) for more information.
...
Also many thanks to the [CanCanCan contributors](https://github.com/CanCanCommunity/cancan/contributors). 
See the [CHANGELOG](https://github.com/CanCanCommunity/cancan/blob/master/CHANGELOG.rdoc) for the full list.
